...
proc ::cm::contact::create-mlist {config} {
    ...
    set emailaddr [string trim [$config @mail]]
	...
	contact new-mail  $contact $emailaddr
...
proc ::cm::contact::merge {config} {
    ...
    puts "Merging contact \"[color name [contact 2label $primary]]\" with ... "

    foreach secondary [$config @secondary] {
	puts -nonewline "  \"[color name [contact 2label $secondary]]\" ... "
	flush stdout
