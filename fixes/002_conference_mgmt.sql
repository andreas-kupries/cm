-- - - -- --- ----- -------- ------------- ---------------------
-- New columns	"conference.management"
...
SELECT	id, title, year,
	(SELECT id FROM contact WHERE tag   = 'tca'),
	(SELECT id FROM email   WHERE email = 'tclconference@googlegroups.com'),
	city, hotel, facility,
	startdate, enddate, alignment, length,
	talklength, sessionlen
FROM conference
;
